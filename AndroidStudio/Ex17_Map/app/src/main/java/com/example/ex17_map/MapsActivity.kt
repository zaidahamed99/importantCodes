...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        //mMap.moveCamera(CameraUpdateFactory.newLatLng(mahidol)) //setting the centre of the screen
        mMap.animateCamera(CameraUpdateFactory.newLatLngZoom(mahidol, 8F)) //Making the map open right on Mahidol (zoomed) amd you dont have to start with the whole Thailand
        ...
        //To move the camera to the center of the point of touch
        ...
        mMap.addPolyline(PolylineOptions()
            .add(LatLng(15.0, 100.45612), LatLng(15.4231, 100.45612))
            .width(5F)
            .color(Color.DKGRAY)
        )

        //To draw a polygon between any number of points
